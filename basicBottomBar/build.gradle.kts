...
kotlin {
    ...
    wasmJs {
        moduleName = "basicBottomBar"
        browser {
            val projectDirPath = project.projectDir.path
            commonWebpackConfig {
                outputFileName = "basicBottomBar.js"
    ...
    sourceSets {
        ...
        commonMain.dependencies {
            ...
            //api("io.github.mejdi14:cmp-bottombar-core:0.4.0")
...
mavenPublishing {
    coordinates(
        artifactId = "cmp-bottombar-basic",
    )

    pom {
        name.set("CMP Bottom Bar - Basic")
        description.set("Basic library for the CMP Bottom Bar multi-platform library.")
